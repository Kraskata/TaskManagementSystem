...
namespace TaskManagementSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(UserFirstNameMaxLength, MinimumLength = UserFirstNameMinLength, ErrorMessage = "The first name must be between 3 and 25 letters long.")]
            public string FirstName { get; set; }

            [Required]
            [Display(Name = "Last name")]
            [StringLength(UserLastNameMaxLength, MinimumLength = UserLastNameMinLength, ErrorMessage = "The last name must be between 3 and 35 letters long.")]
